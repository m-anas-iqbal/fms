        ...
        <div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_content">
								...
								<div class="x_content">
									<br>
									<form id="demo-form2" action="backend/update.php" method="post" enctype="multipart/form-data"  data-parsley-validate="" class="form-horizontal form-label-left">
									<?php
$id = $_GET["id"] ;
$sel="select * from `student` WHERE  `st_id`='".$id."'";
$sno =1;
						  $q1=mysqli_query($db,$sel);
						  while($row =  mysqli_fetch_assoc($q1))
						  {
?>
<input type="hidden" value="<?php echo $row['st_id'] ?>" name="id">
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="fname" value="<?php echo $row['fname'] ?>">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" accept="image/*" id="first-name"  class="form-control " name="img">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" id="first-name" required="required" class="form-control " name="age" value="<?php echo $row['age'] ?>">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="last-name"  class="form-control" name="password" value="<?php //echo $row['pasword'] ?>">
											</div>
										</div>
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Phone Number</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="middle-name" class="form-control" type="number"  name="phone_no" value="<?php echo $row['phone_no'] ?>">
											</div>
										</div>
										<div class="item form-group">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												...
												<button type="submit" class="btn btn-success" name="student_edit">Submit</button>
											</div>
										</div>
										<?php
}

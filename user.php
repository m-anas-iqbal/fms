                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="user" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
						<?php
						  $sel="select * from `staff` order by id";
$sno =1;
						  ...
						  while($row =  mysqli_fetch_assoc($q1))
						  {
							 ...
							 <td>".$row['phone_no']."</td>
							 <td>".$row['email']."</td>
							 <td><a href='user_edit.php?id=".$row['id']."' class='btn btn-primary'>
							 <i class='fa fa-edit'></i> 
						   </a> | <a href='backend/delete.php?id=".$row['id']."&table=staff' class='btn btn-danger'>
